...
;  Josh Simon  Sep14  Added tweakmethod keyword, updated call to jds_deimos_spslit
;
;----------------------------------------------------------------------

pro sg_deimos_2dreduce,  planfile,  chiplist=chiplist, outdir=outdir, $
          file=file, quick=quick, tweakmethod=tweakmethod
